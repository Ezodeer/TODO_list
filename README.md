...
🚀 今後の展望（アップデート予定）
将来的には、このWebアプリケーションをベースとした**Androidアプリ化**を視野に入れています。
展示会やイベントの運営現場では、PCよりもスマートフォンからのアクセスが主流になると想定されるためです。

* **ネイティブアプリ化による軽快な動作**の実現
* **リマインダー機能**を活用したタスク期限のリマインド機能の追加
* カレンダーとタスクの画面切り替え機能
